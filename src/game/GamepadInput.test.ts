...
function fakePad(overrides: { axes?: number[]; buttons?: Record<number, number>; connected?: boolean } = {}): GamepadLike {
...
describe('GamepadInput', () => {
  ...
  it('maps the left stick to pitch and roll, with up meaning forward', () => {
